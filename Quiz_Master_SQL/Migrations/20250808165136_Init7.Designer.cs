...
namespace Quiz_Master_SQL.Migrations
{
    ...
    [Migration("20250808165136_Init7")]
    partial class Init7
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quiz_Master_SQL.Data.Models.TrueOrFalseQuestionDB", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("TrueOrFalseQuestionDB");
            ...
            modelBuilder.Entity("Quiz_Master_SQL.Data.Models.SingleChoiceQuestionDB", b =>
                {
                    b.HasBaseType("Quiz_Master_SQL.Data.Models.TrueOrFalseQuestionDB");

                    b.Property<Guid?>("QuizDBId")
                        .HasColumnType("uniqueidentifier");

                    b.HasIndex("QuizDBId");

                    b.HasDiscriminator().HasValue("SingleChoiceQuestionDB");
                });
            ...
            modelBuilder.Entity("Quiz_Master_SQL.Data.Models.SingleChoiceQuestionDB", b =>
                {
                    b.HasOne("Quiz_Master_SQL.Data.Models.QuizDB", null)
                        .WithMany("SingleChoiceQuestion")
                        .HasForeignKey("QuizDBId");
                });
